                ...
                <div class="pushy-content">
                    <ul>
                        <li class="pushy-submenu">
                            <button><i id="icone_menu" class="fas fa-user"></i></i>Produto</button>
                            <ul>
                    ...
                    <li class="pushy-submenu">
                        <button><i id="icone_menu" class="fas fa-concierge-bell"></i>Venda</button>
                        <ul>
                            <li class="pushy-link"><a href="#"><i id="icone_submenu" class="far fa-file-alt"></i></i>Relatórios</a></li>
                    </li>
                    </ul>
                    </li>
                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"style="font-family:'Roboto Condensed', sans-serif;">
                            <h5 class="lead" id="exampleModalLabel" style="padding-left: 1em; font-size: 17px; font-weight: 500;">Nível de acesso: Gerente</h5>
                            ...
                            <div class="modal1__body">
                                <ul>
                                    <a href="#"><li><i id="ops" class="fas fa-pen-square"></i><?php echo "<a href=editar_gerente.php?editar=" . $id . "><font color='#222'>Editar dados</font></a>"; ?></li></a>
                                    <a href="#"><li><i id="ops" class="fas fa-trash-alt"></i></i><?php echo "<a href='apagar_gerente.php?id=" . $id . "' data-confirm='Tem certeza de que deseja excluir o usuário selecionado?'><font color='#222'>Deletar conta</font></a>" ?></li></a>
