    ...
    <body>
        ...
        <div class="loginbox">
            ...
            <form method="post">
                ...
                <input type="text" name="nome" placeholder="Nome" required="" maxlength="45">
                            ...
                            ?>
                             <div class="alert alert-success alert-dismissible fade show" role="alert">
                               ...
                               <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                ...
                                <a href="criar_adm_inicial.php"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <p class="text-dark">&times;</p>
                                </button>
                                </a>
                            </div>
