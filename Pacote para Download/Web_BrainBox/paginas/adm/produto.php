...
<html lang="pt-br">  
    <head>  
        ...
        <title>Administrador | Produto</title>
                    ...
                    <tbody>
                        ...
                        while ($row_usuario = mysqli_fetch_assoc($resultado_usuario)) {
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td><button type="button" class="btn btn-danger btn-sm" style="text-decoration: none; width: 4em; padding: 4px;"><?php echo "<a href='apagar_produto.php?id=" . $row_usuario['id_produto'] . "' data-confirm='Tem certeza de que deseja excluir o produto selecionado?'><font color='#FFF'>Apagar</font></a>" ?></button></td>
                            </tr>
                        <?php }
                        ?>
                    </tbody>
                        ...
                        <form method="POST" action="editar_produto.php" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="precoc" type="number" step="0.01" class="form-control" id="recipient-c">
                                </div>
                            </div>
                            <div class="form-row" style="text-align: left;">
                                <div class="form-group col-md-6">
                                    <label for="message-text" class="control-label">Preco da Venda:</label>
                                    <input name="precov" type="number" step="0.01" class="form-control" id="recipient-v">
                                </div>
                                <div class="form-group col-md-6">
