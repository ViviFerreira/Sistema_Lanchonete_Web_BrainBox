    ...
    <body>
        ...
        <nav class="pushy pushy-left" data-focus="#first-link">
            <div class="pushy-content">
                <ul>
                    <a href="administrador_inicio.php">
                        <li class="pushy-submenu">
                            <button><i id="icone_menu"class="fas fa-home"></i>Início</button>
                        </li>
                    </a>
                    <li class="pushy-submenu">
                        <button><i id="icone_menu" class="fas fa-user"></i></i>Usuário</button>
                        <ul>
                            <li class="pushy-link"><a href="novos_cadastros.php"><i id="icone_submenu" class="fas fa-plus"></i>Novo cadastro</a></li>
                            <li class="pushy-link"><a href="cliente.php"><i id="icone_submenu" class="fas fa-clipboard-list"></i>Clientes</a></li>
                            <li class="pushy-link"><a href="funcionario.php"><i id="icone_submenu" class="fas fa-clipboard-list"></i>Funcionários</a></li>
                            <li class="pushy-link"><a href="gerente.php"><i id="icone_submenu" class="fas fa-clipboard-list"></i>Gerentes </a></li>
                    </li>
                </ul>
                </li>
                <li class="pushy-submenu">
                    <button><i id="icone_menu"  class="fas fa-hamburger"></i>Produto</button>
                    <ul>
                        <li class="pushy-link"><a href="cadastro_produto.php"><i id="icone_submenu" class="fas fa-plus"></i>Novo cadastro</a></li>
                        <li class="pushy-link"><a href="produto.php"><i id="icone_submenu" class="fas fa-clipboard-list"></i> Cadastrados</a></li>
                        <li class="pushy-link"><a href="categoria.php"><i id="icone_submenu" class="fas fa-clipboard-list"></i> Categorias</a></li>
                    </ul>
                </li>
                <li class="pushy-submenu">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="font-family:'Roboto Condensed', sans-serif;">
                            <h5 class="lead" id="exampleModalLabel" style="padding-left: 1em; font-size: 17px; font-weight: 500;">Nível de acesso: Administrador</h5>
                            ...
                            <ul>
                                <a href="#"><li><i id="ops" class="fas fa-pen-square"></i><?php echo "<a href=editar_adm.php?editar=" . $id . "><font color='#222'>Editar dados</font></a>"; ?></li></a>
                                <a href="#"><li><i id="ops" class="fas fa-trash-alt"></i></i><?php echo "<a href='apagar_admin.php?id=" . $id . "' data-confirm='Tem certeza de que deseja excluir o usuário selecionado?'><font color='#222'>Deletar conta</font></a>" ?></li></a>
